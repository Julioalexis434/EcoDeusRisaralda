...
export function ProviderDestinations({ children }) {
  ...
  const [restaurants] = useState(
    {
      Pereira: [
        ...
        {
          id: "per8",
          nombre: "Restaurante Gastro Bar Discotecas ocultas en Pereira | La Cantina Legre",
          rating: 4.2,
          imagen:
  ...
  return (
    <ContextDestinations.Provider value={{ destinations, setdestinations, hotels, restaurants, municipalities }}>
      {children}
